...
static int arduino_to_mc_md[2][PINS] = {
    // MC
	{NOPWM, NOPWM, NOPWM, MC_MODULE3, NOPWM, MC_MODULE0, MC_MODULE0, NOPWM, NOPWM, MC_MODULE0,
	 MC_MODULE1, MC_MODULE1, NOPWM, MC_MODULE1, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM,
	 NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, MC_MODULE2,
	 MC_MODULE2, MC_MODULE2, MC_MODULE3, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM,
	 NOPWM, NOPWM, NOPWM, NOPWM, NOPWM},
	// MD 
    {NOPWM, NOPWM, NOPWM, MCPWM_MODULEA, NOPWM, MCPWM_MODULEC, MCPWM_MODULEB, NOPWM, NOPWM, MCPWM_MODULEA,
	 MCPWM_MODULEC, MCPWM_MODULEB, NOPWM, MCPWM_MODULEA, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM,
	 NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, MCPWM_MODULEA,
	 MCPWM_MODULEB, MCPWM_MODULEC, MCPWM_MODULEB, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM, NOPWM,
	 NOPWM, NOPWM, NOPWM, NOPWM, NOPWM}
	};
...
static void (*(_userfunc[EXTERNAL_NUM_INTERRUPTS]))(void) = {NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL};
	...
	static int pin_interrupt[EXTERNAL_NUM_INTERRUPTS] = {42, 43, 44, 18, 19, 20, 33, 34, 35, 36, 37, 38};
#endif

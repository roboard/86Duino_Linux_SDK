#ifndef _ROS_pr2_self_test_msgs_TestParam_h
#define _ROS_pr2_self_test_msgs_TestParam_h
...
namespace pr2_self_test_msgs
{
  ...
  class TestParam : public ros::Msg
  {
    public:
      char * key;
      char * value;
    ...
    const char * getType(){ return "pr2_self_test_msgs/TestParam"; };

#ifndef _ROS_SERVICE_GetQueue_h
#define _ROS_SERVICE_GetQueue_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETQUEUE[] = "program_queue/GetQueue";

  class GetQueueRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GETQUEUE; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetQueueResponse : public ros::Msg
  {
    public:

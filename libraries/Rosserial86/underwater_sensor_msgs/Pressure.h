#ifndef _ROS_underwater_sensor_msgs_Pressure_h
#define _ROS_underwater_sensor_msgs_Pressure_h
...
namespace underwater_sensor_msgs
{
  ...
  class Pressure : public ros::Msg
  {
    ...
    const char * getType(){ return "underwater_sensor_msgs/Pressure"; };
    const char * getMD5(){ return "cc86d3e590cd90e822f975defafdf965"; };

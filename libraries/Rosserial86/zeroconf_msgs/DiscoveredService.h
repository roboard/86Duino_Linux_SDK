...
namespace zeroconf_msgs
{
  ...
  class DiscoveredService : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t length_hostname = strlen( (const char*) this->hostname);
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t length_ipv4_addressesi = strlen( (const char*) this->ipv4_addresses[i]);
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t length_ipv6_addressesi = strlen( (const char*) this->ipv6_addresses[i]);
